...
<StepCompornent>
    <template #stepnumber>STEP02</template>
      ...
      <template #question01>{{question03}}</template>
      <template #answer01>
      ...
      <template #question02 v-if="lifeAssurance">{{question04}}</template>
      ...
      <template #question03 v-if="lifeAssurance && hospitalization">{{question05}}</template>
